...
IPAddress TCP_IP ( 10, 0, 0, 35 );				// Configure your static ip-address here
uint8_t TCP_MAC[] = { 0x02, 0xDE, 0xAD, 0x00, 0x01, 0x42 };	// Mac-address - You should change this! see note *2 above!
